...
//						System.out.println(newM+","+newS+"뉴엠뉴스");
...
//		System.out.println(movefireball.size()+"냐오오옹");
...
//				System.out.println("보정 후 "+r+","+c);
			}
			
//			System.out.println("최종이동후"+r+","+c);
